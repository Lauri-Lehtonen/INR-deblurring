...
def parser_fn(argv):
    ...
    # Deblurring options
    deblur_parser.add_argument("--nn_model", type=str, choices=['SIREN', 'FOURIER_MAPPED_MLP', 'HASH_ENCODING', 'DICTIONARY_FIELD'], default=None, help='Neural network model to be used')
